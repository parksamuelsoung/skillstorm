...
function fallPage() {
    ...
    button.innerText = fall.querySelector("p").querySelector("button").innerText;
...
function springPage() {
    ...
    button.innerText = spring.querySelector("p").querySelector("button").innerText;
...
function summerPage() {
    ...
    button.innerText = summer.querySelector("p").querySelector("button").innerText;
...
function winterPage() {
    ...
    button.innerText = winter.querySelector("p").querySelector("button").innerText;
